...
CREATE PROCEDURE [dbo].[Заказы_SIUD]
    ...
    @UIDСтоимости AS UNIQUEIDENTIFIER = NULL,
...
BEGIN
    ...
    BEGIN   
        SELECT з.UIDЗаказа
              ...
              ,dbo.ГаражПолучитьЦенуАвто(з.UIDТовара) AS [Цена авто]
    ...
    BEGIN
        SELECT з.UIDЗаказа
              ,з.UIDТовара
              ,з.UIDСтоимости
              ,dbo.ГаражПолучитьЦенуАвто(з.UIDТовара) AS [Стоимость]
              ,з.UIDКлиента
              ,з.НомерЗаказа
              ,з.ДатаЗаказа
              ,з.IdСтатусаЗаказа
