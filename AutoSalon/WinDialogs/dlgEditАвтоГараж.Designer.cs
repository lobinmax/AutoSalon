partial class dlgEditАвтоГараж
{
    ...
    {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(dlgEditАвтоГараж));
            this.textEditЦветАвто = new System.Windows.Forms.ColorDialog();
            ...
            this.textEditГодВыпуска.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.textEditТолькоЦыфры_KeyPress);
            // 
            // textEditПробег
            // 
            ...
            this.comboBoxМарка.SelectedValueChanged += new System.EventHandler(this.comboBoxМарка_SelectedValueChanged);
            // 
            // labelControl3
            // 
            ...
            this.simpleButtonСохранить.Click += new System.EventHandler(this.simpleButtonСохранить_Click_1);
            // 
            // label1
            // 
            ...
            // textEditСтоимость
            // 
            this.textEditСтоимость.Location = new System.Drawing.Point(327, 198);
            this.textEditСтоимость.Name = "textEditСтоимость";
            this.textEditСтоимость.Size = new System.Drawing.Size(98, 20);
            this.textEditСтоимость.TabIndex = 47;
            this.textEditСтоимость.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.textEditТолькоЦыфры_KeyPress);
            // 
            // labelColor
            // 
            ...
            // 
            // checkBoxОбновитьСтатистику
            // 
            this.checkBoxОбновитьСтатистику.AutoSize = true;
            this.checkBoxОбновитьСтатистику.Checked = true;
            this.checkBoxОбновитьСтатистику.CheckState = System.Windows.Forms.CheckState.Checked;
            this.checkBoxОбновитьСтатистику.Enabled = false;
            this.checkBoxОбновитьСтатистику.Location = new System.Drawing.Point(291, 227);
            this.checkBoxОбновитьСтатистику.Name = "checkBoxОбновитьСтатистику";
            this.checkBoxОбновитьСтатистику.Size = new System.Drawing.Size(134, 17);
            this.checkBoxОбновитьСтатистику.TabIndex = 55;
            ...
            this.Controls.Add(this.textEditСтоимость);
            this.Controls.Add(this.label3);
            this.Controls.Add(this.textEditVIN);
            this.Controls.Add(this.textEditНомерКузова);
    ...
    #endregion
    private System.Windows.Forms.ColorDialog textEditЦветАвто;
